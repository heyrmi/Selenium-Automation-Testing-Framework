...
/**
 * This class is responsible for logging directly in extent reports and not using log4j or others libraries
 */
public final class FrameworkLogger {
    ...
    private static final Consumer<String> TAKESCREENSHOT = (message)-> ExtentManager.getExtentTest().info("Screenshot : ",
